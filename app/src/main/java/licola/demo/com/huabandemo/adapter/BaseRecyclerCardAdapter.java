...
//
///**
// * Created by LiCola on  2016/03/22  18:11
// * 抽象类adapter 采用模板方法模式
// * 抽象出取关键方法 放到子类实现
// */
//public abstract class BaseRecyclerCardAdapter<T> extends RecyclerView.Adapter<BaseRecyclerCardAdapter.ViewHolder> {
...
//    }
//
//    public BaseRecyclerCardAdapter(Context context) {
...
//        }
//
//        //检查 是否有 图片是否被采集信息 控制显隐
//        int love=bean.getLike_count();//被喜欢数量
//        int gather=bean.getRepin_count();//被转采的数量
//
//        if (love>0||gather>0){
//            holder.ll_info.setVisibility(VISIBLE);
//
//            holder.tv_card_love.setText(" "+love);
//            holder.tv_card_gather.setText(" "+gather);
//        }else {
//            holder.ll_info.setVisibility(View.GONE);
//        }
//
//        holder.tv_card_love.setCompoundDrawablesWithIntrinsicBounds(
...
//            @Override
//            public void onClick(View v) {
//                mListener.onClickTitleInfo(bean, holder.ll_info);
//            }
//        });
//    }
//
...
//        public final TextView tv_card_love;
//
...
//            tv_card_love= (TextView) view.findViewById(R.id.tv_card_love);
//        }
//
//    }
//}
